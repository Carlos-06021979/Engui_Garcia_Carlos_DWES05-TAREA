...
function resolverAcciones()
{
  ...
  if (isset($_POST['cargar_partida_inicial']) && isset($_POST['archivo_partida'])) {
    ...
    if ($partidaCargada) {
      ...
      $_SESSION['pantalla_principal_mostrada'] = true; // Forzamos mostrar el tablero
      // Redirigimos para evitar reenvío de formulario y mostrar el tablero
...
function guardarPartida($partida, $nombrePartida = null)
{
  ...
  // Aseguramos que la carpeta de partidas existe
  $directorioPartidas = __DIR__ . '/../data/partidas';
  if (!is_dir($directorioPartidas)) {
    mkdir($directorioPartidas, 0777, true);
  }
